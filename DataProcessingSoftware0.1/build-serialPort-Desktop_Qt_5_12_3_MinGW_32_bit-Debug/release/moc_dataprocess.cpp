...
#include "../../serialPort/dataprocess.h"
...
QT_MOC_LITERAL(1, 12, 12), // "data_display"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "dataprocess\0data_display\0"
};
...
void dataprocess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (dataprocess::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataprocess::data_display)) {
                *result = 0;
                return;
            }
        }
